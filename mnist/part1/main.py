...
# print('softmax test_error 1=', run_softmax_on_MNIST(temp_parameter=0.5))
# print('softmax test_error 2=', run_softmax_on_MNIST(temp_parameter=1))
# print('softmax test_error 3=', run_softmax_on_MNIST(temp_parameter=2))
...
print('softmax test error mnist mod3=', run_softmax_on_MNIST_mod3(temp_parameter=1))
